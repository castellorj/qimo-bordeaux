  ...
  return (
    <article>
      <div className="overflow-hidden">
        ...
        {/* Barra "Ver fotos e detalhes" — mesma dinâmica dos cards do Chef. */}
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
          aria-expanded={open}
          className="flex w-full items-center justify-center gap-2 border-t bg-petrol-600 px-4 py-2.5 font-sans text-[11px] font-semibold uppercase tracking-wide text-cream shadow-[inset_0_1px_0_rgba(255,255,255,.16)]"
      ...
      {open && (
        <div className="animate-fade-up container-editorial py-12">
          <div className="mx-auto max-w-3xl">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <ActivityReserve contentKey={g.slug} inline />
              </div>
            </div>
          </div>
        </div>
