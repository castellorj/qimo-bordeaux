...
export const chefExperiences: ChefExperience[] = [
  {
    ...
    heroImage: "/media/haut-brion-jantar.jpg",
    gallery: [
      "/media/haut-brion-jantar.jpg",
      "/media/haut-brion-salao.jpg",
      "/media/haut-brion-vinhos.jpg",
      "/media/haut-brion-la-mission.jpg",
      "/media/haut-brion-cave.jpg",
    ],
