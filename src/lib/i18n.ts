...
export const ui: Dict = {
  ...
  "nav.mapa-rota": { pt: "Mapa da rota", en: "Route map", es: "Mapa de la ruta" },
  ...
  "nav.gastronomia": { pt: "Golf", en: "Golf", es: "Golf" },
  ...
  "navd.mapa-rota": { pt: "Bordeaux pelo rio", en: "Bordeaux by river", es: "Bordeaux por el río" },
  ...
  "navd.gastronomia": { pt: "Campos e tee times", en: "Courses & tee times", es: "Campos y tee times" },
  ...
  "hero.gastronomia.k": { pt: "Golfe em Bordeaux", en: "Golf in Bordeaux", es: "Golf en Bordeaux" },
  "hero.gastronomia.i": {
    pt: "Os grandes campos da região.",
    en: "The region's great courses.",
    es: "Los grandes campos de la región.",
  },
